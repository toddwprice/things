...
module block_with_thread_in(dia,hi,thread_length,block_x,block_y)
...
//  thread_length = length of threaded part of bolt
...
//	block_y=width of the block.
{
	...
	tranlate([0,0, hi - thread_length]) thread_in(dia, thread_length); //Add the thread.
}
